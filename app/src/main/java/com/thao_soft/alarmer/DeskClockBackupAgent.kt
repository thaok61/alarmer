...
class DeskClockBackupAgent : BackupAgent() {
    ...
    override fun onRestoreFinished() {
        ...
        Log.d(TAG, "Waiting for %s to complete the data restore $ACTION_COMPLETE_RESTORE")
    }

    companion object {
        const val TAG = "DeskClockBackupAgent"

        const val ACTION_COMPLETE_RESTORE = "com.thao.deskclock.action.COMPLETE_RESTORE"
