...
class AsyncRingtonePlayer(private val mContext: Context) {
    ...
    val audioAttributes: AudioAttributes = AudioAttributes.Builder()
        ...
        .build()
    private val mFocusRequest = AudioFocusRequest.Builder(AudioManager.AUDIOFOCUS_GAIN_TRANSIENT)
    ...
    private fun checkAsyncRingtonePlayerThread() {
        if (Looper.myLooper() != mHandler!!.looper) {
            Log.e("Must be on the AsyncRingtonePlayer thread!",
    ...
    private inner class MediaPlayerPlaybackDelegate : PlaybackDelegate {
        ...
        override fun play(context: Context, ringtoneUri: Uri?, crescendoDuration: Long): Boolean {
            ...
            Log.d(TAG,"Play ringtone via android.media.MediaPlayer.")
            ...
            if (alarmNoise == null) {
                ...
                Log.d(TAG, "Using default alarm: $alarmNoise")
            }
        ...
        override fun stop(context: Context?) {
            ...
            Log.d(TAG,"Stop ringtone via android.media.MediaPlayer.")
    ...
    private inner class RingtonePlaybackDelegate : PlaybackDelegate {
        ...
        override fun play(context: Context, ringtoneUri: Uri?, crescendoDuration: Long): Boolean {
            ...
            Log.d(TAG,"Play ringtone via android.media.Ringtone.")
            ...
            if (mRingtone == null) {
                Log.d(TAG,"Unable to locate alarm ringtone, using internal fallback ringtone.")
            ...
            try {
                ...
                Log.e(TAG, "Using the fallback ringtone, could not play $ringtoneUriVariable", t)
        ...
        override fun stop(context: Context?) {
            ...
            Log.d(TAG,"Stop ringtone via android.media.Ringtone.")
    ...
    companion object {
        val TAG: String = AsyncRingtonePlayer::class.java.simpleName
        ...
        private fun computeVolume(currentTime: Long, stopTime: Long, duration: Long): Float {
            ...
            Log.d(TAG,"Ringtone crescendo ${fractionComplete * 100} complete (scalar: ${volume}, volume: $gain dB)",)
